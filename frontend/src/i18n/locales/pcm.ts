...
export const pcm: Messages = {
  ...
  auth: {
    title: "Sign in",
    lead: "Na for di team wey dey publish verification.",
    username: "Username",
    password: "Password",
    submit: "Sign in",
    working: "E dey sign you in…",
    failed: "Dis details no match any account.",
    throttled: "You don try too many times. Wait one minute make you try again.",
    required: "Put your username and password.",
    needed: "Abeg sign in make you fit open di dashboard.",
    signOut: "Comot",
  ...
  widget: {
    ...
    previewRecording: "Listen am before you send",
    micDenied: "Ma’at no fit use your microphone. Allow am for your browser settings, or type wetin you hear.",
    heard: "Wetin I hear",
    notHeard: "Ma’at no fit hear that voice note well. Try again near the microphone, or type wetin you hear.",
    spokenReply: "Ma’at reply, wey dem read out",
    citedSource: "Source",
