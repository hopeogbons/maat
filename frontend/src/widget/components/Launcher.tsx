...
interface LauncherProps {
  ...
  hideWhilePanelShown: boolean
  onClick: () => void
  ref?: Ref<HTMLButtonElement>
}

export function Launcher({ open, panelId, hideWhilePanelShown, onClick, ref }: LauncherProps) {
  const iconBase =
  ...
  return (
    <button
      ...
      className={cn(
        ...
        hideWhilePanelShown && 'maat:hidden maat:sm:inline-flex',
      )}
    >
